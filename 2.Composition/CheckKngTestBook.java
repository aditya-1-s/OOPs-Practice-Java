public class CheckKngTestBook {
    public static void main(String[] args) {
        CheckKNGAuthor a1 = new CheckKNGAuthor("Tan Ah Teck", "ahteck@nowhere.com");
        ...
        // Test Book class
        CheckKNGBook b1 = new CheckKNGBook("12345", "Java for dummies", a1, 8.8, 88);
